          ...
          <ScrollAnimation animation="slide-left" delay={300} className="relative">
            <div className="grid grid-cols-2 gap-3 lg:gap-4">
              <div className="space-y-3 lg:space-y-4">
                <Image
                  src="https://cdn.pixabay.com/photo/2021/01/04/06/21/man-5886576_1280.jpg?height=300&width=250"
                ...
                />
                <Image
                  src="https://cdn.pixabay.com/photo/2016/11/29/09/11/fit-1868634_1280.jpg?height=200&width=250"
              ...
              <div className="space-y-3 lg:space-y-4 pt-6 lg:pt-8">
                <Image
                  src="https://cdn.pixabay.com/photo/2016/11/19/12/43/barbell-1839086_1280.jpg?height=200&width=250"
