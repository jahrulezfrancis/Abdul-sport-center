...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Abdul Sport Center completely transformed my approach to fitness. The trainers are incredibly knowledgeable and supportive. I've lost 30 pounds and gained so much confidence in just 6 months!",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=150&width=150",
    rating: 5,
    text: "After years of struggling with consistency, Abdul Sport Center changed everything. The supportive environment and expert guidance helped me develop healthy habits that stick.",
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 max-w-3xl mx-auto">
            Real transformations from real people. Discover how Abdul Sport Center has helped our members achieve their
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-lg text-warm-600 max-w-3xl mx-auto">
              ...
              transformed their lives at Abdul Sport Center.
            </p>
          </div>
      ...
      <section className="py-20 bg-primary-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8">
            Join hundreds of satisfied members who have transformed their lives at Abdul Sport Center. Your journey
            starts today.
          </p>
