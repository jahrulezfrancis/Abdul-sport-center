...
const milestones = [
  {
    year: "2014",
    title: "Foundation",
    description: "Abdul Sport Center was founded with a vision to create a premium fitness experience.",
  },
  {
    year: "2016",
    title: "Expansion",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <ScrollAnimation animation="slide-right">
              <div className="space-y-8">
                <h2 className="font-serif text-3xl lg:text-4xl font-bold text-navy-900">
                  The Abdul Sport Center Journey
                </h2>
                <div className="space-y-6">
                  <p className="text-lg text-slate-700 leading-relaxed">
                    What started as a dream to create the perfect fitness environment has grown into a thriving
                    community of fitness enthusiasts. Abdul Sport Center was founded in 2014 with a simple mission: to
          ...
          <ScrollAnimation animation="scale-in">
            <div className="space-y-8">
              ...
              <p className="text-lg lg:text-xl text-primary-100">
                Experience the Abdul Sport Center difference. Schedule a tour today and see why we're the premier choice
